...
const testReadScenario = (fileNames, expectedCalls) => {
  const newsDirPath = './././data/local/news/articles';
...
describe('readScenario helper', () => {
  ...
  it('should readScenario given a valid array and directory name', () => {
    ...
    const expectedCalls = [
      ['./././data/local/news/articles/c0000000001o.json'],
      ['./././data/local/news/articles/c0000000002o.json'],
      ['./././data/local/news/articles/c0000000003o.json'],
    ];
